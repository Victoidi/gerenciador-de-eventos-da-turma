...
export function AdminAccessDenied({ email }: { email?: string | null }) {
  return (
    <main className="flex min-h-screen items-center justify-center px-4 py-10">
      <section className="w-full max-w-lg rounded-lg border border-line bg-surface p-6 shadow-soft">
        ...
        {email ? (
          <p className="mt-3 rounded-lg bg-parchment px-3 py-2 text-sm text-muted">
